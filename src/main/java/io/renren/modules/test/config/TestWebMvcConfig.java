...
public class TestWebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    @Autowired
    ApiTestUtils apiTestUtils;

    @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/testReport/**")
                .addResourceLocations("file:" + stressTestUtils.getCasePath() + File.separator);
        registry.addResourceHandler("apiShowReport/**").addResourceLocations("file:"+apiTestUtils.getReportPath()+File.separator);
        registry.addResourceHandler("export/**").addResourceLocations("file:"+apiTestUtils.getMockServicePath()+File.separator);
    }
}
