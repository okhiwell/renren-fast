...
//        new JavassistEngine().fixJmeterStandrdEngine();
    ...
    public String runSingle(Long fileId) {
        ...
        logger.info(stressTestFile.getFileName());
        logger.info(stressTestFile.getStatus().toString());
        ...
        if (StressTestUtils.NEED_REPORT.equals(stressTestFile.getReportStatus())) {
            ...
            logger.info(stressTestReports.toString());
        }
        ...
        logger.info(stressTestFile.toString());
