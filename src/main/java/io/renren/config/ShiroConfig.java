...
//        filterMap.put("/logout", "logout");
        ...
        filterMap.put("/test/apiReports/downloadReport/*?*", "anon");
        filterMap.put("/test/apiFile/downloadFile/*?*", "anon");
        filterMap.put("test/*?*", "anon");
        filterMap.put("/test/mock/export/*?*", "anon");
        filterMap.put("/test/nodedetail/info/*?*", "anon");
        filterMap.put("/test/node/**", "anon");
        filterMap.put("/test/tool/sublist/**/*?*", "anon");
        filterMap.put("/testReport/**", "anon");
        filterMap.put("/logwebsocket/*?*", "anon");
        filterMap.put("/apiShowReport/**", "anon");
